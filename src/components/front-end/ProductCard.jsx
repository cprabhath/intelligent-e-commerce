    ...
    <div className="border border-gray-200">
      ...
      <div className="px-8 py-4">
        ...
        <div className="flex justify-between items-center mt-4">
          <h2 className="font-medium text-black text-xl">${price}</h2>
          <div
            className="flex gap-2 items-center bg-pink-700 text-white px-4 py-2 cursor-pointer hover:bg-pink-900"
